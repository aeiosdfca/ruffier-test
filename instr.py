...
txt_instruction = ("Данное приложение позволит вам с помощью теста Руфье провести первичную диагностику вашего здоровья. \n"
                   ...
                   "У испытуемого находящегося в положении лежа на спине в течении 5 минут, определяет частоту пульса за 15 секунд; \n" 
                   ...
                   "а потом - за последние 15 секунд первой минуты после восстановления. \n"
...
txt_test3 = '''Лягте на спину и замрерьте пульс  сначала первые 15 секунд минуты, затем за последние 15 секунд. \n Нажмите кнопку
               "Начать финальный тест", чтобы запустить таймер. \n Зеленым обозначены секунды, в течение которых необходимо \n проводить измерения,
               черными - секунды без замера пульсаций. Результаты запишите в соответсвующие поля.'''
